...
namespace ads::ds::rbt::iterators {
    ...
    public:
        ...
        explicit Iterator(ads::ds::rbt::node_impl::RBNode<T>* ptr) : Iter{ ptr } {};
        ...
        reference             operator*                                   ()                       const { return (Iter->key); };
        ads::ds::rbt::node_impl::RBNode<T>* operator->                    ()                       const { return Iter; };
